...
-- Users can read buildings they belong to or all buildings (for joining)
CREATE POLICY "Users can view all buildings for joining" ON buildings
    FOR SELECT USING (true);

-- RLS Policies for profiles
-- Users can read profiles in their building (excluding phone numbers - handled in app)
...
-- Users can read spots in their building
...
-- Users can manage their own spots
...
-- Users can see requests where they are borrower or lender
